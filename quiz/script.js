...
function fun() {
    ...
    document.getElementById("opt1").onclick = function() { next() };
    document.getElementById("opt2").onclick = function() { next() };
    document.getElementById("opt3").onclick = function() { next() };
